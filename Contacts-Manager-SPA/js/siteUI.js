        ...
        <div class="bookmarkdeleteForm">
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
                <div class="bookmarkContainer">
                 ...
                 <div>
                    <img src="${faviconUrl}" alt="Favicon" class="bookmarkFavicon" onerror="this.style.display='none';" />
                    <a href="${bookmark.Url}"><span class="bookmarkTitle">${bookmark.Title}</span></a>
                 </div>
...
function renderBookmarkForm(bookmark = null) {
    ...
    let faviconUrl = create ? "https://pic.onlinewebfonts.com/thumbnails/icons_558703.svg": getFaviconUrl(bookmark.Url);
    $("#actionTitle").text(create ? "Création" : "Modification");
    $("#content").append(`
        <form class="form" id="bookmarkForm">
        <div>
        <img src=${faviconUrl} alt="Favicon" class="bookmarkFormFavicon"  ;" /><br/><br/>
        </div>
    ...
    $('#Url').on('input', function () {
        let faviconImage = $('.bookmarkFormFavicon');
        const urlValue = $(this).val();
        let faviconUrl = getFaviconUrl(urlValue);

        faviconImage.attr("src", faviconUrl);
        faviconImage.on("error", function () {
            faviconImage.attr("src", "https://pic.onlinewebfonts.com/thumbnails/icons_558703.svg");
        });
    });
...
function getFaviconUrl(bookmarkUrl) {
    return `https://www.google.com/s2/favicons?sz=64&domain_url=${bookmarkUrl}`;
}
